...
INSTALL_BINDIR=../install/bin
INSTALL_VPNSERVER_DIR=../install/vpnserver/
INSTALL_VPNBRIDGE_DIR=../install/vpnbridge/
INSTALL_VPNCLIENT_DIR=../install/vpnclient/
INSTALL_VPNCMD_DIR=../install/vpncmd/
